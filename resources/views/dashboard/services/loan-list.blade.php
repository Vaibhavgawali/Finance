                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-6 col-lg-3">
                                                    <div class="form-group pb-3">
                                                        ...
                                                        <textarea name="present_line1" id="present_line1"
                                                            class="form-control" cols="1" rows="1"
                                                            placeholder="Address Line 1"></textarea>
                                                    </div>
                                                    <div class="form-group pb-3">
                                                        <label for="present_line2">Address Line 2</label>
                                                        <textarea name="present_line2" id="present_line2"
                                                            class="form-control" cols="1" rows="1"
                                                ...
                                                <div class="col-md-6 col-lg-3">
                                                    <div class="form-group pb-3">
                                                        ...
                                                        <textarea name="present_line3" id="present_line3"
                                                            class="form-control" cols="1" rows="1"
                                                    ...
                                                    <div class="form-group pb-3">
                                                        ...
                                                        <input class="form-control" type="text" name="present_landmark"
                                                            id="present_landmark" placeholder="Landmark">
                                                    </div>
                                                </div>
                                                <div class="col-md-6 col-lg-3">
                                                    <div class="form-group pb-3">
                                                ...
                                                <div class="col-md-6 col-lg-3">
                                                    <div class="form-group pb-3">
                                                        ...
                                                        <input class="form-control" name="present_pincode"
                                                            id="present_pincode" type="text" placeholder="Pincode">
                                                    </div>
                                                    <div class="form-group pb-3">
                                                        <label for="present_phone">Phone Number</label>
                                                        <input class="form-control" name="present_phone"
                                                            id="present_phone" type="number" placeholder="Phone Number">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-6 col-lg-3">
                                                    <div class="form-group pb-3">
                                                        ...
                                                        <textarea name="office_line1" id="office_line1"
                                                            class="form-control" cols="1" rows="1"
                                                            placeholder="Address Line 1"></textarea>
                                                    </div>
                                                    <div class="form-group pb-3">
                                                        <label for="office_line2">Address Line 2</label>
                                                        <textarea name="office_line2" id="office_line2"
                                                            class="form-control" cols="1" rows="1"
                                                            placeholder="Address Line 2"></textarea>
                                                    </div>
                                                </div>
                                                <div class="col-md-6 col-lg-3">
                                                    <div class="form-group pb-3">
                                                        ...
                                                        <textarea name="office_line3" id="office_line3"
                                                            class="form-control" cols="1" rows="1"
                                                            placeholder="Address Line 3"></textarea>
                                                    </div>
                                                    <div class="form-group pb-3">
                                                        ...
                                                        <input class="form-control" type="text" name="office_landmark"
                                                            id="office_landmark" placeholder="Landmark">
                                                    </div>
                                                </div>
                                                <div class="col-md-6 col-lg-3">
                                                    <div class="form-group pb-3">
                                                ...
                                                <div class="col-md-6 col-lg-3">
                                                    ...
                                                    <div class="form-group pb-3">
                                                        ...
                                                        <input class="form-control" name="office_phone"
                                                            id="office_phone" type="number" placeholder="Phone Number">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                                ...
                                                <div class="col-lg-4 stretch-card grid-margin">
                                                    <div class="card bg-gradient-primary card-img-holder text-white">
                                                        <div class="card-body">
                                                            ...
                                                            <h2 class="mb-2">Identity Proof (Adhaar, PAN, Passport )</h2>
                                        ...
                                        success: function(response) {
                                            ...
                                            console.log(response.document_type)
                                             ...
                                             function updateFileLink(linkId, fileName) {
                                                var fileUrl = "{{ asset('storage/loan/') }}/" + fileName;
