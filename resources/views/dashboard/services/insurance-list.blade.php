                        ...
                        <table id='example' class="table table-striped  ">
                            ...
                            <thead class="">
                                <tr>
                                    ...
                                    <th class="">Insurer ID</th>
                                    <th class="">Insurer Name</th>
                                    <th class="">Total Premium</th>
                                    <th class="">Enquiry No.</th>
                                    <th class="">Policy No.</th>
                                    <th class="">Policy Status</th>
                                    <th class="">Enquiry Type</th>
                        ...
                        $(document).ready(function() {
                            ...
                            var table = $('#example').DataTable({
                                ...
                                initComplete: function() {
                                    ...
                                    var userHasRole = <?php echo auth()->user()->hasRole('Superadmin') || auth()->user()->hasRole('Admin') ? 'true' : 'false'; ?>;
