        ...
        <div class="content-wrapper">
            ...
            <div class="row">
                <x-dashboard-card :bgClass="'bg-gradient-primary'" :url="'/credit-card'" :imageUrl="asset('admin-assets/assets/images/dashboard/circle.svg')" :title="'Credit Card'" :totalCountLabel="'Total Count'"
                    :totalCount="$creditCardCount" :icon="'mdi-credit-card'" :btnbg="'btn btn-sm btn-primary'" :applyUrl="'/credit'" />
                <x-dashboard-card :bgClass="'bg-gradient-secondary'" :url="'/loan'" :imageUrl="asset('admin-assets/assets/images/dashboard/circle.svg')" :title="'Loan'"
                    :totalCountLabel="'Total Count'" :totalCount="$loanCount" :icon="'mdi-cash-multiple'" :btnbg="'btn btn-sm btn-primary'" :applyUrl="'/loan-service'" />
                <x-dashboard-card :bgClass="'bg-gradient-success'" :url="'/demat'" :imageUrl="asset('admin-assets/assets/images/dashboard/circle.svg')" :title="'Demat'"
                    :totalCountLabel="'Total Count'" :totalCount="$dematCount" :icon="'mdi-bank-outline'" :btnbg="'btn btn-sm btn-primary'" :applyUrl="'/demat/create'" />
                <x-dashboard-card :bgClass="'bg-gradient-danger'" :url="'/insurance'" :imageUrl="asset('admin-assets/assets/images/dashboard/circle.svg')" :title="'Insurance'"
                    :totalCountLabel="'Total Count'" :totalCount="$insuraceCount" :icon="'mdi-cash'" :btnbg="''" :applyUrl="'/dashboard'" />
