    ...
    <div class="profile-address-section card">
        <div class="d-flex justify-content-between p-3">
            ...
            @if (auth()->user()->id == $data->id)
                <button class="btn btn-gradient-primary btn-sm " id="bank_details_edit_button"><i
            ...
            <form class="forms-sample" id="bank_details_update_form">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="bank_name" id="bank_name" placeholder="Bank Name"
                        disabled value='{{ $data->bank ? $data->bank->bank_name : '' }}'>
                    <div id="bank_name_error"></div>
                </div>
                <div class="form-group">
                    <label for="acc_holder_name">Account Holder Name</label>
                    <input type="text" class="form-control" name="acc_holder_name" id="acc_holder_name"
                        placeholder="Account Holder Name" disabled
                        value='{{ $data->bank ? $data->bank->acc_holder_name : '' }}'>
                    <div id="acc_holder_name_error"></div>
                </div>
                <div class="form-group">
                    <label for="acc_number">Account Number</label>
                    <input type="text" class="form-control" name="acc_number" id="acc_number"
                        placeholder="Account Number" disabled value='{{ $data->bank ? $data->bank->acc_number : '' }}'>
                    <div id="acc_number_error"></div>
                </div>
                <div class="form-group">
                    <label for="ifsc_code">NEFT IFSC Code</label>
                    <input type="text" class="form-control" name="ifsc_code" id="ifsc_code"
                        placeholder="NEFT IFSC Code" disabled value='{{ $data->bank ? $data->bank->ifsc_code : '' }}'>
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="facebook" id="facebook" placeholder="Facebook"
                        disabled
                        value='{{ $data->social_links->where('social_site', 'Facebook')->first()->profile_url ?? '' }}'>
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="instagram" id="instagram" placeholder="Instagram"
                        disabled
                        value='{{ $data->social_links->where('social_site', 'Instagram')->first()->profile_url ?? '' }}'>
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="linkedin" id="linkedin" placeholder="LinkedIn"
                        disabled
                        value='{{ $data->social_links->where('social_site', 'LinkedIn')->first()->profile_url ?? '' }}'>
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="twitter" id="twitter" placeholder="Twitter"
                        disabled
                        value='{{ $data->social_links->where('social_site', 'Twitter')->first()->profile_url ?? '' }}'>
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="telegram" id="telegram" placeholder="Telegram"
                        disabled
                        value='{{ $data->social_links->where('social_site', 'Telegram')->first()->profile_url ?? '' }}'>
                ...
                @if (auth()->user()->id == $data->id)
                    <div id="bank_details_update_button_div">
                        <button type="submit" class="btn btn-gradient-primary me-2"
                            id="bank_details_update_button">Update</button>
