    ...
    <div class="card">
        ...
        <div class="profile-img-div text-center">
            @if (auth()->user()->id == $data->id)
                @if ($data->profile && $data->profile->profile_image)
                    <div id="image-view-1">
                        <img src="{{ asset('storage/images/') }}/{{ $data->profile->profile_image }}"
                            alt="{{ $data->profile->profile_image }}" class="img-fluid">
                        <div class="mt-3" id="change-profile-image">
                            <button class="btn btn-primary btn-sm" onclick="toggleProfileImageDiv()">Update
                                image</button>
                        ...
                        <form action="" id="Profile-image-upload-form">
                            ...
                            <div class="d-flex w-100 justify-content-center align-items-center ">
                                <button style="display:none" ; type="submit"
                                    class="btn btn-sm btn-gradient-primary me-2  my-3" id="">Upload</button>
                    ...
                    <script>
                        function toggleProfileImageDiv() {
                            ...
                            profileImageDiv.style.display = (profileImageDiv.style.display === 'none' || profileImageDiv.style.display ===
                                '') ? 'block' : 'none';
                ...
                @else
                    <form action="" id="Profile-image-upload-form">
                        ...
                        <br>
                        <div class="d-flex w-100 justify-content-center align-items-center ">
                            <button style="display:none" ; type="submit" class="btn btn-gradient-primary me-2  my-3"
                                id="image-upload-button">Upload</button>
                        </div>
                    </form>
                @endif
            @else
        ...
        <div class="profile-personal-info-section">
            <div class="profile-personal-info-div p-3">
                ...
                @if (auth()->user()->id == $data->id)
                    <div class="text-end">
                        <button class="btn btn-gradient-primary btn-sm " id="basic_details_edit_button"><i
                ...
                <form class="forms-sample" id="basic_details_update_form">
                    ...
                    <div class="form-group">
                        ...
                        <input type="email" class="form-control" id="email" name="email"
                            placeholder="Email" disabled value=" {{ $data->email }}">
                        <div id="name_error"></div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="phone" name="phone"
                            placeholder="Phone" disabled value="{{ $data->phone }}">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="father_name" name="father_name"
                            ...
                            value='{{ isset($data->profile) ? $data->profile->father_name : '' }}'>
                        <div id="father_name_error"></div>
                    </div>

                    <div class="form-group">
                        <label for="date_of_birth">Date of birth</label>
                        <input type="date" class="form-control p-4" name="date_of_birth" id="date_of_birth"
                            placeholder="Date Of Birth" disabled
                            value='{{ isset($data->profile) ? $data->profile->date_of_birth : '' }}'>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="alt_phone" name="alt_phone"
                            placeholder="Alternate Contact Number" disabled
                            value='{{ isset($data->profile) ? $data->profile->alt_phone : '' }}'>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="pan" name="pan"
                            ...
                            value='{{ isset($data->profile) ? $data->profile->pan : '' }}'>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="address" name="address"
                            placeholder="Address" disabled value="{{ $data->phone }}">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="pincode" id="pincode"
                            ...
                            value='{{ isset($data->address) ? $data->address->pincode : '' }}'>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="city" id="city" placeholder="City"
                            disabled value='{{ isset($data->address) ? $data->address->city : '' }}'>
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control" name="gst" id="gst" disabled>
                            ...
                            <option value="1"
                                {{ $data->profile ? ($data->profile->gst ? 'selected' : '') : '' }}>Yes</option>
                            <option value="0" {{ !$data->profile || !$data->profile->gst ? 'selected' : '' }}>
                                No</option>
                    ...
                    <div class="form-group" id="gst_number_field"
                        style="display: {{ $data->profile ? ($data->profile->gst ? 'block' : 'none') : 'none' }}">
                        <label for="gst_number">GST Number</label>
                        <input type="text" class="form-control" name="gst_number" id="gst_number"
                            placeholder="GST Number"
                            value='{{ $data->business->where('document_title', 'gst')->first()->document_number ?? '' }}'>
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control" name="msme" id="msme" disabled>
                            <option value="1"
                                {{ $data->profile ? ($data->profile->msme ? 'selected' : '') : '' }}>Yes</option>
                            <option value="0" {{ !$data->profile || !$data->profile->msme ? 'selected' : '' }}>
                                No</option>
                    ...
                    <div class="form-group" id="msme_number_field"
                        style="display: {{ $data->profile && $data->profile->msme ? 'block' : 'none' }} ">
                        <label for="msme_number">MSME Number</label>
                        <input type="text" class="form-control" name="msme_number" id="msme_number"
                            placeholder="MSME Number"
                            value='{{ isset($data->business) && $data->business->where('document_title', 'msme')->first() ? $data->business->where('document_title', 'msme')->first()->document_number : '' }}'>
                    ...
                    @if (auth()->user()->id == $data->id)
                        <div id="basic_details_update_button_div">
                            <button type="submit" class="btn btn-gradient-primary me-2"
                                id="basic_details_update_button">Update</button>
