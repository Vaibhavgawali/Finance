    ...
    <section>
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-4 col-md-6 mb30">
                    <a href="/creditcard?creditcard=IDFC Credit Card">
                        <div class="f-box f-border f-icon-left f-icon-rounded f-box-s1">
                            <i class=" bg-color text-light"> <img src="assets/images/services-logos/2.jpg" alt=""></i></i>
                            <div class="fb-text ">
                ...
                <div class="col-lg-4 col-md-6 mb30">
                    <a href="/creditcard?creditcard=IndusInd Credit Card">
                        <div class="f-box f-border f-icon-left f-icon-rounded f-box-s1">
                            <i class=" bg-color text-light"><img src="assets/images/services-logos/3.jpg" alt=""></i></i>
                            <div class="fb-text">
                ...
                <div class="col-lg-4 col-md-6 mb30">
                    <a href="/creditcard?creditcard=SBI Credit Card">
                        <div class="f-box f-border f-icon-left f-icon-rounded f-box-s1">
                            <i class="bg-color text-light">
                ...
                <div class="col-lg-4 col-md-6 mb30">
                    <a href="/creditcard?creditcard=AU Credit Card">
                        <div class="f-box f-border f-icon-left f-icon-rounded f-box-s1">
                            <i class="bg-color text-light">
