                                ...
                                <div class="row">
                                    <div class="row">
                                        <div class="col-12 mb-1">
                                            <label for=""
                                                class="text-left text-[#2A2C5D] font-bold text-1xl">Present Address</label>
                                        </div>
                                        ...
                                        <div class="col-md-6 col-lg-3">
                                            <div class="form-group pb-3">
                                                <input class="form-control" type="" name="present_state"
                                                    id="present_state" placeholder="State">
                                                <div id="present_state_error" class="text-danger mx-2"></div>
                                            </div>
                                            <div class="form-group pb-3">
                                                <input class="form-control" type="" id="present_city"
                                                    name="present_city" placeholder="City">
                                        ...
                                        <div class="col-md-6 col-lg-3">
                                            <div class="form-group pb-3">
                                                <input class="form-control" type="" id="present_pincode"
                                                    name="present_pincode" placeholder="Pincode">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6 col-lg-3">
                                            <div class="form-group pb-3">
                                                <input class="form-control" type="" name="office_state"
                                                    id="office_state" placeholder="State">
                                                <div id="office_state_error" class="text-danger mx-2"></div>
                                            </div>
                                            <div class="form-group pb-3">
                                                <input class="form-control" type="" id="office_city"
                                                    name="office_city" placeholder="City">
                                        ...
                                        <div class="col-md-6 col-lg-3">
                                            <div class="form-group pb-3">
                                                <input class="form-control" type="" name="office_pincode"
                                                    id="office_pincode" placeholder="Pincode">
                      ...
                      class="containerDiv w-full flex justify-start items-start flex-wrap h-auto max-h-[300px] overflow-y-auto mt-5">
                                ...
                                <div style="overflow: auto">
                                    <div style="float: right">
                                        ...
                                        <button class="btn btn-primary nextBtn" type="submit" id="loan_submit_btn"
                                            class="submit-btn">
                                            Submit
                                        </button>
                                    </div>
