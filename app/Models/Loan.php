...
class Loan extends Model
{
    ...
    protected $fillable = [
        ...
        'pan_num', 'credit_score', 'marital_status', 'mother_name', 'select_document_type', 'upload_document','pan_file', 'adhar_front_file', 'adhar_back_file', 'itr_file', 'bank_statement_file','status','application_stage','approval_date','remark'
    ];
